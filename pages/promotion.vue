...
const messages = [
  {
    title: '募集職種',
    lead: 'hq35（T11）以上！ファイター、シューター特化で成長を止めず前向きに育成されている方',
    caption: 'ライダーはcc40多数在籍により要相談',

    color: 'pink',
  },
  {
    title: '業務内容',
    lead: '荒野、浄水で敵国の猛者をぶち倒してください！',
    caption:
      '敵シューターにいつもやられています。腕っぷしに自信のある強ファイター求む',
